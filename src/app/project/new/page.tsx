    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-gray-100">
            <div className="form-group bg-white p-6 rounded-lg shadow-md">
                <label htmlFor="driveUrl" className="block text-lg font-semibold text-gray-700">Add project drive</label>
                <p className="description mt-2 text-sm text-gray-600">
                    Go to your drive and add this service account to the folder you want to use for your project: <br />
                    <span className="font-medium text-gray-800">main-694@project-management-405211.iam.gserviceaccount.com</span>
                </p>
                <input
